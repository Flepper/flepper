...
## Filing issues
When filing issues, please use our [issue templates](https://github.com/nicolastakashi/flepper/blob/contributing-md/ISSUE_TEMPLATE.MD).
...
Flepper team and community members will provide feedback on your change. Community feedback is highly valued. You will often see the absence of team feedback if the community has already provided good review feedback. 

1 or more Flepper team members will review every PR prior to merge. They will often reply with "LGTM, modulo comments". That means that the PR will be merged once the feedback is resolved. "LGTM" == "looks good to me".
