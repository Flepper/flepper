...
namespace Flepper.Core.QueryBuilder.Join.Operators.Intersection.Extensions
{
    ...
    {
        public static IJoinComparisonOperators Equal(this IIOnOperator onOperator, string column)
        {
            var joinComparisonOperator = JoinComparisonOperators.Create();

            joinComparisonOperator.Equal(column);

            return joinComparisonOperator;
        }

        public static IJoinComparisonOperators NotEqual(this IIOnOperator onOperator, string column)
        {
            var joinComparisonOperator = JoinComparisonOperators.Create();

            joinComparisonOperator.NotEqual(column);
